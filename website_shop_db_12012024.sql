...
--
-- Хост: localhost:3306
-- Время создания: Янв 12 2024 г., 10:15
...
ALTER TABLE `chapter`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_4pbtn7t1bcgwbcqfd8p6t2v4i` (`link`),
  ADD UNIQUE KEY `UK_7hd975gdvebj3q7e28cp0s2c9` (`title`),
  ADD UNIQUE KEY `UK_s2uak0bdu2frkacvekg6w9n70` (`title_ukr`);
...
ALTER TABLE `sections`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_84nb8lu7bfetcusqy83135qdv` (`link`),
  ADD UNIQUE KEY `UK_jg77d3ptkoskjyfdxh6ltms8s` (`title`),
  ADD UNIQUE KEY `UK_h6p93emclit4ub0hthv6pcibv` (`title_ukr`),
  ADD KEY `FK5d8vlg44swhb528ljrjirx3gj` (`chapter`);
...
--
ALTER TABLE `sections`
  ADD CONSTRAINT `FK5d8vlg44swhb528ljrjirx3gj` FOREIGN KEY (`chapter`) REFERENCES `chapter` (`id`);
COMMIT;
